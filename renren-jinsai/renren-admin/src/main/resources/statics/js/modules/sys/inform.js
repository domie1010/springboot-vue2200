$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'sys/inform/list?'+"type=通知公告",
        datatype: "json",
        colModel: [
            { label: 'id', name: 'id', index: 'id', width: 20 },
            { label: '创建时间', name: 'createTime', index: 'createTime', width: 40 },
            { label: '通知标题', name: 'title', index: 'title', width: 60 },
            { label: '通知内容', name: 'content', index: 'content', width: 100 },
            { label: '通知类型', name: 'type', index: 'type', width: 40 },
        ],
        viewrecords: true,
        height: 385,
        rowNum: 10,
